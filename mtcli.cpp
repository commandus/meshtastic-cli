...
static const char *programName = "meshtastic-cli";
...
public:
    ...
    bool parseArgs(int argc, char **argv) {
        ...
        struct arg_lit *a_enable_serial = arg_lit0("s", "serial", _("enable COM port"));
        ...
        void* argtable[] = {
            ...
            a_enable_serial, a_serial_ports,
        ...
        enableSerial = a_enable_serial->count > 0  || a_serial_ports->count > 0;

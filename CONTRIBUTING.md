...
Please send a [GitHub Pull Request](https://github.com/commandus/meshtastic-cli/pull/new/master) with a clear list of what you've stop (read more about [pull requests](http://help.github.com/pull-requests/)). 
